...
const Utente = sequelize.define('Utente', {
    ...
    /**
     * Codice per il reset della password
     * Utilizzato per la procedura di recupero password
     *
     * Caratteristiche:
     * - Può essere null (presente solo durante la procedura di reset)
     * - Stringa di massimo 100 caratteri
     */
    codice_password: {
        type: DataTypes.STRING(100),
        allowNull: true
