        ...
        if (this.userForm) {
            this.userForm.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    errorMessage.textContent = 'Errore nella gestione dell\'utente. Riprova più tardi.';
    ...
    initEditButtons() {
        document.querySelectorAll('.btn-icon[title="Modifica"]').forEach(button => {
            button.addEventListener('click', async (e) => {
                ...
                const loadingSpinner = this.showLoadingSpinner(button);
                ...
                try {
                    ...
                    const errorMessage = document.createElement('div');
                    errorMessage.className = 'alert alert-danger';
                    errorMessage.textContent = 'Errore nel caricamento dei dati dell\'utente. Riprova più tardi.';
            ...
            button.addEventListener('click', async (e) => {
                ...
                if (confirm('Sei sicuro di voler eliminare questo utente?')) {
                    try {
                        ...
                        const errorMessage = document.createElement('div');
                        errorMessage.className = 'alert alert-danger';
                        errorMessage.textContent = 'Errore nell\'eliminazione dell\'utente. Riprova più tardi.';
